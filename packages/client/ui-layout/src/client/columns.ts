 ...
 * The solver is breakpoint-free: which surfaces are present at all is the
 * layout's and the device model's answer (shell.ts), never a width here.
 */
...
/** Sidebar width when it is a sheet over the work (a phone's session list). */
export const SIDEBAR_SHEET = 320
