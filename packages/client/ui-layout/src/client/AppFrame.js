...
function AppFrameInner({ useStore, useSessions, actions, renderSlot, }) {
    ...
    return (_jsxs("div", { ref: frameRef, className: css.frame, style: {
        ...
        }, "data-sidebar-collapsed": sidebarCollapsed || undefined, "data-details-collapsed": cols.details === 0 || undefined, "data-dragging": dragging || undefined, children: [renderSlot('shell.mobile_trigger', {
                collapsed: sidebarCollapsed,
                onToggle: () => actions.toggleSidebar(),
            }, {
                fallback: (_jsx("div", { className: css.mobileHamburger, onClick: () => actions.toggleSidebar(), title: "Open Menu", children: _jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("line", { x1: "3", y1: "12", x2: "21", y2: "12" }), _jsx("line", { x1: "3", y1: "6", x2: "21", y2: "6" }), _jsx("line", { x1: "3", y1: "18", x2: "21", y2: "18" })] }) })),
            }), _jsx("div", { className: css.sidebarCol, children: renderSlot('sidebar', {
                    collapsed: sidebarCollapsed,
                    width: cols.sidebar,
                }) }), _jsxs(_Fragment, { children: [_jsx(CenterColumn, { children: renderSlot('conversation', {}) }), _jsx(DetailsColumn, { children: renderSlot('details', {}) })] }), _jsx("div", { className: css.overlayLayer, "data-shell-overlay": true, children: renderSlot('shell.overlay', {}) }), !sidebarCollapsed && _jsx(DragHandle, { side: "sidebar", left: cols.sidebar, onStart: onSidebarStart, onDrag: onSidebarDrag, onEnd: onDragEnd }), cols.details > 0 && _jsx(DragHandle, { side: "details", left: viewport - cols.details, onStart: onDetailsStart, onDrag: onDetailsDrag, onEnd: onDragEnd }), !sidebarCollapsed && narrow && (_jsx("div", { className: css.mobileBackdrop, onClick: () => actions.toggleSidebar() }))] }));
}
export function AppFrame(props) {
    ...
    if (authStatus === 'unauthenticated')
        return _jsx(LoginScreen, { onLoginSuccess: () => setAuthStatus('authenticated') });
    return _jsx(AppFrameInner, { ...props });
}
