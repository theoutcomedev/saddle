...
/**
 * No runtime invariant: this package renders user-opened panes in the details
 * column and owns no cordis events or cross-plugin mutable state. Its single
 * slot registration plus each pane's registration prove disposal through the
 * HMR-safety spec.
 */
