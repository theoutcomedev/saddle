...
const BUILTIN_THEMES: readonly ThemeDefinition[] = Object.freeze([
  ...
  Object.freeze({ id: 'palomino', colorScheme: 'light' as const, tokens: Object.freeze({
    '--dsw-alias-bg-base': '#FDFBF7',
    '--dsw-alias-bg-layer-1': '#FDFBF7',
    '--dsw-alias-bg-layer-2': '#F8F4EA',
    '--dsw-alias-bg-layer-3': '#F5EFDF',
    '--dsw-alias-bg-overlay': '#F5EFDF',
    '--dsw-alias-bg-module-platform': '#F0E8D5',
    '--dsw-specific-sidebar-fill': '#F8F4EA',
    '--dsw-specific-sidebar-nav-item-active': '#E8DFC7',
    '--dsw-specific-sidebar-nav-item-hover': '#F0E8D5',
    '--dsw-specific-sidebar-nav-item-active-accent': '#CBA75C',
    '--dsw-alias-button-elevated-fill': '#FFFFFF',
    '--dsw-alias-button-floating-fill': '#F8F4EA',
    '--dsw-alias-button-floating-hover': '#F0E8D5',
    '--dsw-specific-input-major': '#FFFFFF',
    '--dsw-specific-selector': '#F0E8D5',
    '--dsw-specific-menu': '#F8F4EA',
    '--dsw-alias-text-p1': '#4A3B2C',
    '--dsw-alias-text-p2': '#6B5A47',
    '--dsw-alias-label-primary': '#4A3B2C',
    '--dsw-alias-label-secondary': '#6B5A47',
    '--dsw-alias-label-tertiary': '#8C7762',
    '--dsw-alias-interactive-bg-hover': 'rgba(74, 59, 44, 0.06)',
    '--dsw-alias-interactive-bg-hover-solid': '#E8DFC7',
    '--dsw-alias-border-l1': 'rgba(74, 59, 44, 0.08)',
    '--dsw-alias-border-l2': 'rgba(74, 59, 44, 0.14)',
    '--dsw-alias-border-l2-darkmode-thin': 'rgba(74, 59, 44, 0.10)',
  }) }),
