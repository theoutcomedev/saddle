...
export const zh = {
  ...
  'menu.sessionLog': '会话日志',
  'menu.deleteSession': '删除会话',
  'deleteSession.title': '永久删除会话',
  'deleteSession.desc': '将永久删除“{name}”及其全部数据（对话记录与文件改动无法恢复）。',
  'deleteSession.confirm': '删除',
  'deleteSession.pending': '正在删除…',
...
export const en = {
  ...
  'deleteSession.desc': 'This permanently deletes “{name}” and all of its data. The conversation and any file changes it made cannot be recovered.',
  'deleteSession.confirm': 'Delete',
  'deleteSession.pending': 'Deleting…',
