  ...
  interface SlotMap {
    ...
    'conversation.session.header': {
      ...
      owner: {
        ...
        /** The active layout keeps one chrome row rather than two. */
...
export interface ConversationInjected {
  ...
  /** Toggle the workbench details drawer. */
...
export interface ConversationSessionHeaderInjected {
  ...
  toggleWorkbench?: (() => void) | undefined
}
...
export type DetailsSlotProps = PropsRuntime<'workbench.pane.details'> & PropsRenderSlots<'conversation.details.tool'>
