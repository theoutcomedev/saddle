...
export const zh = {
  ...
  'rewind.title': '回退对话',
  'rewind.description': '对话将回退到此消息，并从此处继续（原对话保留在列表中，可随时返回）。',
...
export const en = {
  ...
  'rewind.description': 'The conversation will rewind to this message and continue from here. The original stays in your list, so you can always go back.',
