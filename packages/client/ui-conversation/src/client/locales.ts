...
export const zh = {
  ...
  'message.rewind': '回退到此消息',
  'rewind.title': '回退对话',
  'rewind.description': '对话将回退到此消息并在此继续。此消息之后的对话记录将被撤销。',
  'rewind.revertFiles': '同时撤销此点之后修改的所有文件',
  'rewind.confirm': '回退',
  'rewind.cancel': '取消',
  'rewind.checking': '正在检查文件冲突…',
  'rewind.checkFailed': '无法检查其他会话的文件改动。',
  'rewind.collisions': '这些文件也在其他会话中被修改过，回退将覆盖那些修改：',
  'rewind.affectedFiles': '确认此回退操作将应用以下文件更改：',
  'rewind.noFilesAffected': '未修改任何文件。',
...
export const en = {
  ...
  'rewind.description': 'The conversation will rewind to this message. Messages and responses after this point will be reverted.',
  'rewind.revertFiles': 'Also revert all file changes made after this point',
  'rewind.confirm': 'Rewind',
  'rewind.cancel': 'Cancel',
  'rewind.checking': 'Checking for file conflicts…',
  'rewind.checkFailed': 'Could not check other conversations for file changes.',
  'rewind.collisions': 'These files were also changed in other conversations. Rewinding will overwrite those changes:',
  'rewind.affectedFiles': 'Confirming this undo action will make the following changes:',
  'rewind.noFilesAffected': 'No files affected.',
