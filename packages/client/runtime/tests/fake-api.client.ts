...
export class FakeApiClient implements IApiClient {
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    rewindCollisions: (payload: unknown) => this.record('session.rewindCollisions', payload, Promise.resolve(ok({ collisions: [] }))),
  ...
  readonly connections: IApiClient['connections'] = {
    list: payload => this.record('connections.list', payload, Promise.resolve(ok({ flows: [], mcp: [] }))),
    connect: payload => this.record('connections.connect', payload, Promise.resolve(ok({ attemptId: 'a' }))),
    poll: payload => this.record('connections.poll', payload, Promise.resolve(ok({ state: 'connecting' }))),
  ...
  readonly apps: IApiClient['apps'] = {
    list: payload => this.record('apps.list', payload, Promise.resolve(ok({ apps: [] }))),
    restart: payload => this.record('apps.restart', payload, Promise.resolve(ok({ success: true }))),
    stop: payload => this.record('apps.stop', payload, Promise.resolve(ok({ success: true }))),
    delete: payload => this.record('apps.delete', payload, Promise.resolve(ok({ success: true }))),
