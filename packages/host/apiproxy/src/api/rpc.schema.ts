...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('fs-error'), message: z.string(), details: z.record(z.string(), z.unknown()) }),
  ...
  z.object({ code: z.literal('connection-not-found'), message: z.string(), details: z.object({ key: z.string() }) }),
  z.object({ code: z.literal('connection-attempt-invalid'), message: z.string(), details: z.object({ attemptId: z.string() }) }),
